      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              href="mailto:arya.pathrikar@example.com"
              className="group flex flex-col items-center transition-all duration-300"
              aria-label="Email"
            >
              <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center mb-1.5 group-hover:bg-pink-900/50 transition-colors border border-gray-700 group-hover:border-pink-500/50">
          ...
          <div className="flex flex-col items-center gap-4">
            <a
              href="https://github.com/AryaPathrikar/next.js-portfolio"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className="text-sm text-gray-400 text-center">
              &copy; {new Date().getFullYear()} All rights reserved by Arya Pathrikar
            </div>
          </div>
        </div>
      </div>
